...
Script to compute correlation absis-functions for 
various anisotropic configurations of the GW background 
energy-density

--Stephen Taylor (May 2014)
...
def Fminus00(qq, mm,ll,zeta): # Eq. (E32)
    ##########
    integrand = 0.
    #qq = mm
...
def Fminus01(qq, mm,ll,zeta): # Eq. (E39)
    ##########
    integrand = 0.
...
def Fplus01(qq, mm,ll,zeta):  # Eq. (E37)
    ##########
    integrand = 0.
...
def Fplus00(qq, mm,ll,zeta): # Eq. (E36)
    ##########
    integrand = 0.
